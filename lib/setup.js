...
// One-time setup endpoint — safe to leave in place; it only ever creates
// data if it doesn't already exist, and requires knowing the admin password.
// Visit: /api/setup?key=YOUR_ADMIN_PASSWORD
